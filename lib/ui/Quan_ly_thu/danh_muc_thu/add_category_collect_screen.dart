...
class AddCategoryCollectScreen extends StatefulWidget {
  const AddCategoryCollectScreen({Key? key}) : super(key: key);
  @override
  _AddCategoryCollectScreenState createState() => _AddCategoryCollectScreenState();
}
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title:  const Center(child: Text("Thêm danh mục thu "),),
      ),
                ...
                child: FlatButton(
                  ...
                  child: Row(
                    ...
                    children:  <Widget>[
                      ...
                      Text("Thêm",style: AppThemes.commonText.copyWith(color: Colors.white),),
                    ],
                  ),
                  ...
                  onPressed:(){
                    ...
                    if(_nameController.text.trim().isNotEmpty){
                     BlocProvider.of<CategoryCollectBloc>(context).add(CreateCategoryCollectEvent(categoryCollect: categoryCollect),);
                    }else{
                      FunctionHelper.showSnackBar(context: context, title: 'Bạn cần nhập tên danh mục thu !');
